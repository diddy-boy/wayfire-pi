...
window.active.title.bg.color: #1e1e2e 75
window.inactive.title.bg.color: #1e1e2e 40
...
menu.items.bg.color: #1e1e2e 75
menu.items.text.color: #cdd6f4
menu.items.active.text.color: #cdd6f4
menu.title.bg.color: #1e1e2e 75
EOF

        # 4. Glass Panel styling
        write_wf_panel_pi_glass 20 20 30 0.65
...
A reboot or logout/login is required to switch sessions." 18 70
